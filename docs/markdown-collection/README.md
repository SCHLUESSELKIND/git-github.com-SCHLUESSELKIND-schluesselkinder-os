...
services/soundsystem-inference  Internal FastAPI scaffold for AI music jobs
...
- Internal SNUFFRAGA SOUNDSYSTEM AI ENGINE architecture pack
- Internal FastAPI inference scaffold with prompt compilation and mock generation jobs

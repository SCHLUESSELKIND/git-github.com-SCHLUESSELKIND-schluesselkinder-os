        ...
        <div className="mx-auto max-w-7xl px-5 py-8 md:px-8 md:py-10">
          <div className="grid gap-8 border-l border-stone-800 pl-5 md:grid-cols-[0.24fr_1fr_0.28fr] md:items-end md:pl-8">
            <div>
              ...
              <p className="mt-5 text-xs font-black uppercase tracking-[0.45em] text-stone-600">{record.id}</p>
            </div>
            <div>
              <h1
                className="max-w-5xl break-words font-black uppercase text-stone-100"
                style={{ fontSize: "clamp(2.45rem, 8.8vw, 7.75rem)", lineHeight: 0.86, overflowWrap: "anywhere" }}
              >
                {record.title}
              </h1>
            </div>
